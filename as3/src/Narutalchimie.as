package  
{
	...
	import lymeh.naturalchimie.Main;
	...
	public class Narutalchimie extends Sprite
	{
		...
		private function start():void
		{
			...
			*/
			var viewPort:Rectangle = new Rectangle(0,0,Constants.STAGE_WIDTH, Constants.STAGE_HEIGHT);
			...
			_starling.stage.stageWidth  = Constants.STAGE_WIDTH;  // <- same size on all devices!
			_starling.stage.stageHeight = Constants.STAGE_HEIGHT; // <- same size on all devices!
